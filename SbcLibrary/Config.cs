...
namespace SbcLibrary
{
    public class Config
    {
        ...
        public int MainEntryPoint { get; set; }
        public int IrqEntryPoint { get; set; }
        public int ExecutableStart { get; set; }
        public int ExecutableSize { get; set; }
        public int ConstStart { get; set; }
        public int ConstSize { get; set; }
        public int HeapPointer { get; set; } = 0x0FFF0;
